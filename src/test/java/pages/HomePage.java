...
public class HomePage {
    ...
    public WebElement signupLogoutButton;
    ...
    public LoginSignupPage signupLogoutClick() {
        signupLogoutButton.click();
        return new LoginSignupPage(driver);
    }
    ...
    public HomePage scrollUpButtonClick() {
        ...
        SeleniumHelper.clickElementByJS(driver,scrollUpButton);
        return this;
    }
