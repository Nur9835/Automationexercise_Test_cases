...
public class EnterAccountInformationPage {
    ...
    public AccountCreatedPage fillAccountDetails() throws IOException, ParseException, ParseException {

        titleMrCheckbox.click();
        passwordInput.sendKeys(JSONReader.existingUser("password"));
        ...
        scroll_pixel(100);
        clickElementByJS(driver,newsletterCheckbox);
        wait_second(5);
        clickElementByJS(driver,specialOffersCheckbox);
        wait_second(5);
       // newsletterCheckbox.click();
        ...
        clickElementByJS(driver,createAccountButton);
